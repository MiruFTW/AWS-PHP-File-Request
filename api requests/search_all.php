...
if (!isset($_POST['submit']))
{
	...
	echo '<h2>Results from all files</h2>';
	$sql="SELECT `auto_id`,`file_name`,`loanID`,`file_type`,`file_status`,`file_size`,`file_datetime` FROM `files`";
	...
	echo '<thead><tr><td>File Name</td><td>Loan ID</td><td>File Type</td><td>Upload Method</td><td>File Size</td><td>File Upload Date Time</td><td>Action</td></tr></thead>';
